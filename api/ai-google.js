...
- NÃO confunda tempo total de voo (ex: 16h 50min) com tempo de conexão
- "Uma escala" = "com conexão"
- Se for Iberia, a conexão geralmente é em Madrid
- Passageiros: formato "XX adultos" ou "XX adultos + XX crianças"
- NÃO inclua links genéricos ou incompletos (https://...)
- Se não houver link específico, omita completamente a linha do link
